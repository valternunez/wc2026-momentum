...
FRAG = {
    "en": {
        ...
        "tip_copa": "Copa América 2024: national teams in the same US summer, but the smallest sample here ({{COPA_N}} windows, one per break, counting only the side that was ahead, so an odd number is normal). Its low −{{COPA_DELTA}} is noisy; read it next to the others, not on its own.",
    ...
    "es": {
        ...
        "tip_copa": "Copa América 2024: selecciones en el mismo verano de EE. UU., pero la muestra más chica de aquí ({{COPA_N}} ventanas, una por pausa, contando solo al equipo que iba arriba, así que un número impar es normal). Su −{{COPA_DELTA}} bajo es ruidoso; léelo junto a los demás, no por sí solo.",
...
STRINGS = {
    "en": {
        ...
        "HERO_LEDE": "FIFA made in-match hydration breaks mandatory at the 2026 World Cup. Coaches and pundits call them momentum killers. Through {{N_MATCHES}} matches the team on top really does sag, but mostly for a reason that has nothing to do with the whistle.",
        ...
        "S05_LEAD2": "So run the <em style=\"font-style:italic\">exact same measurement</em> where no break was mandated (on the same FotMob scale) and put the −{{HERO_DELTA}} next to it. The cleanest control is the very same 2026 matches at quiet minutes: −{{P26_DELTA}}. Add national-team football with no breaks at all (World Cup 2022 at −{{WC22_DELTA}}, Euro 2024 at −{{EURO_DELTA}}, the noisier Copa América 2024 at −{{COPA_DELTA}}), and the no-break baseline lands around −{{NOBREAK_LO}} to −{{NOBREAK_HI}}. So most of the −{{HERO_DELTA}} is the team cooling off anyway. But not all of it: the break still sits about {{GAP}} points below the same teams with no whistle, {{GAP_CLAUSE}}.",
        "S05_CAVEAT_BOX": '''Same statistic, same scale. The gold-standard control is the same 2026 teams at quiet minutes (−{{P26_DELTA}}), and Euro 2024 and World Cup 2022 land right with it (−{{EURO_DELTA}}, −{{WC22_DELTA}}): national-team football regresses about −{{NOBREAK_LO}} to −{{NOBREAK_HI}} on its own. Clubs swing more (the Club World Cup drops −{{CWC_DELTA}}), which is why an earlier club-only comparison flattered the "same drop" read. The break (−{{HERO_DELTA}}) sits about {{GAP}} points below the same-teams control once their pre-break level is matched, {{GAP_CLAUSE}}. The sample is small, so it's suggestive, not proven. <span style="color:#5A5547">(An event-xT cross-check on 2022 agrees the slide is real.)</span>''',
        ...
        "STORY_VERDICT_SUB": "The break still sits about {{GAP}} points below the same teams with no whistle, {{GAP_CLAUSE}}.",
        # slide 6 — CTA
        "STORY_CTA_H": "A living analysis.",
        ...
        "SHARE_TEXT": "Do hydration breaks really kill momentum? A living, data-driven look at the 2026 World Cup:",
...
<p>National-team football regresses about −{{NOBREAK_LO}} to −{{NOBREAK_HI}} on its own. The break (−{{HERO_DELTA}}) sits about {{GAP}} points below the same-teams control once their pre-break level is matched, {{GAP_CLAUSE}}.</p>''',
...
<p><a class="src" href="{{PAGES_URL}}">github.com/valternunez/wc2026-momentum ↗</a></p>''',
    ...
    "es": {
        ...
        "HERO_LEDE": "La FIFA volvió obligatorias las pausas de hidratación en el Mundial 2026. Técnicos y comentaristas las llaman asesinas del momentum. A lo largo de {{N_MATCHES}} partidos, el equipo que domina sí se desinfla, pero sobre todo por una razón que nada tiene que ver con el silbatazo.",
        ...
        "S01_LEAD": "Cada partido es lo mismo: el árbitro hace una pausa obligatoria hacia la mitad de cada tiempo y ambos equipos trotan hacia la banda para tres minutos de agua e instrucciones. Sin embargo, no todos están convencidos de que sea necesaria.",
        ...
        "STORY_VERDICT_SUB": "La pausa todavía queda unos {{GAP}} puntos por debajo de los mismos equipos sin silbatazo, {{GAP_CLAUSE}}.",
        # diapositiva 6 — CTA
        "STORY_CTA_H": "Un análisis vivo.",
        ...
        "SHARE_TEXT": "¿Las pausas de hidratación de verdad matan el momentum? Un análisis vivo, basado en datos, del Mundial 2026:",
...
<p>El futbol de selecciones regresa por su cuenta alrededor de −{{NOBREAK_LO}} a −{{NOBREAK_HI}}. La pausa (−{{HERO_DELTA}}) queda unos {{GAP}} puntos por debajo del control de mismos equipos una vez igualado su nivel previo, {{GAP_CLAUSE}}.</p>''',
