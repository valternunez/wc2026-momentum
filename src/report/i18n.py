...
STRINGS = {
    "en": {
        ...
        "S02_MOMDEF": '''An index of which side is on top, built from the flow of attacks, shots and dangerous moves, not the scoreline — <strong style="font-weight:600">FotMob's</strong> per-minute momentum. Positive means the home team is pressing, negative the away team. The project <em style="font-style:italic">reads</em> this number, it doesn't compute one; all it does is measure how it moves in the five minutes either side of a stoppage.''',        "S02_LEAD": "Take the team on top before a break and track what it loses over the next five minutes, split by what kind of stoppage cut in. Every stoppage type leans the same way — down for the side that was on top.",
...
<p><a class="src" href="{{PAGES_URL}}">github.com/valternunez/wc2026-momentum ↗</a></p>''',
    ...
    "es": {
        ...
        "S01_FOLLOW": '''La queja de Van Dijk es sobre el ritmo y los cortes comerciales. La acusación más filosa es táctica, y hasta en la cabina de TV tienen un nombre para ello: Emma Hayes (directora técnica de la selección femenina de Estados Unidos, como comentarista en ITV) las llama <em style="font-style:italic">pausas de momentum</em>: <span style="color:#1A1813">«ventajosas para el equipo que está perdiendo el momentum… cuando dominas, no las quieres; cuando vas cayendo, sí.»</span> <a class="src" href="https://www.espn.com/soccer/story/_/id/48945011/why-there-drinks-breaks-2026-world-cup-fifa-criticised">[ESPN]</a> Y es esta misma idea la que los datos de este proyecto ponen a prueba.''',
        "S02_HEAD": "02 — Qué hace cada interrupción",
        "S02_MOMLABEL": "Qué significa «momentum» aquí",
        "S02_MOMDEF": '''Un índice sobre qué equipo domina, construido a partir del flujo de ataques, remates y jugadas de peligro, no del marcador — el momentum por minuto de <strong style="font-weight:600">FotMob</strong>. Positivo significa que presiona el equipo local; negativo, el visitante. Este proyecto <em style="font-style:italic">lee</em> ese número, no calcula uno nuevo; lo único que hace es medir cómo se mueve en los cinco minutos a cada lado de una interrupción.''',        "S02_LEAD": "Toma al equipo que dominaba antes de una pausa y mira qué pierde en los cinco minutos siguientes, según el tipo de interrupción que lo cortó. Todas las interrupciones se inclinan igual: hacia abajo para el que iba arriba.",
