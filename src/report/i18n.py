...
<p><a class="src" href="{{PAGES_URL}}">github.com/valternunez/wc2026-momentum ↗</a></p>''',
    ...
    "es": {
        ...
        "HERO_LEDE": "La FIFA volvió obligatorias las pausas de hidratación en el Mundial 2026. Técnicos y comentaristas las llaman asesinas del momentum. A lo largo de {{N_MATCHES}} partidos, el equipo que domina sí se desinfla tras una pausa. Pero se desinfla casi lo mismo sin pausa alguna.",
