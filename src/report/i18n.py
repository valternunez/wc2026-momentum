...
STRINGS = {
    "en": {
        ...
        "BOTTOM_T1": "The leader sags about −{{HERO_DELTA}} after a break — but the same teams sag −{{P26_DELTA}} at quiet minutes with no whistle. That leaves a gap of about {{GAP}} (95% CI {{GAP_LO}} to {{GAP_HI}}).",
