...
<p><a class="src" href="{{PAGES_URL}}">github.com/valternunez/wc2026-momentum ↗</a></p>''',
    ...
    "es": {
        ...
        "BOTTOM_LEAD_OPEN": "En la superficie parece matar el momentum. Pero el equipo que domina se desinfla casi lo mismo sin pausa alguna, así que el plus de la pausa aún no está probado.",
