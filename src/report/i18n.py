...
STRINGS = {
    "en": {
        ...
        "S04_CONCL": '''If a water break were only about <em style="font-style:italic">rest</em>, a long VAR pause should match it. So far it doesn't quite, which hints at the <strong style="font-weight:600;color:#EFEBDF">coaching window</strong> a break creates. Belgium's Rudi Garcia put it plainly: <span style="color:#EFEBDF">"for me, it's a coaching break more than a cooling break."</span> <a class="src" href="https://www.aljazeera.com/sports/2026/6/20/hydration-break-boos-how-fifa-united-players-fans-coaches-at-world-cup">[Al Jazeera]</a> One caveat we won't bury: the comparison is mostly by stoppage type rather than perfectly duration-matched (the breaks themselves are now timed, but VAR and injury timings are patchier), and the "with sub" injury split is confounded by the substitution itself. Once we control for pre-break momentum, the hydration and VAR intervals <strong style="font-weight:600;color:#EFEBDF">overlap</strong>. Not a verdict, but suggestive. And a VAR pause still lets a coach shout instructions from the touchline, so at most this comparison understates the coaching window rather than inventing it.''',
