...
FRAG = {
    "en": {
        ...
        "cc_copa_sub": "S. American NT, US summer · noisy (shown, not in the range)",
    ...
    "es": {
        ...
        "cc_copa_sub": "selecciones sudamericanas, verano de EE. UU. · ruidoso (se muestra, fuera del rango)",
