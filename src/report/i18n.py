...
<li><strong>Duraciones de pausa, ahora medidas.</strong> Las marcas de inicio/fin de ESPN dan una duración exacta para {{DUR_N}} de {{DUR_N_ALL}} pausas de hidratación con equipo arriba (mediana {{DUR_MEDIAN}}, {{DUR_MIN}}–{{DUR_MAX}}); la cobertura de VAR y lesión es más delgada. Si las pausas <em style="font-style:italic">más largas</em> pegan más fuerte es inconcluso con la muestra actual —el intervalo de la pendiente incluye el cero— así que no nos apoyamos en eso.</li>
